...
import com.nadap.components.TestemonialCard
...
fun TestimonialContent(){
    ...
    Column(
        ...
        SectionTtile(modifier = Modifier
            .fillMaxWidth()
            .margin(bottom = 25.px),
...
fun TestimonialCards(
    selectedPage: Int,
    breakpoint: Breakpoint) {
    val testimonial1 = listOf(Testimonial.First, Testimonial.Third, Testimonial.Fift)
    ...
    SimpleGrid(
        ...
        Box {
            testimonial2.forEach { testimonial ->
                TestemonialCard(
                    modifier = Modifier
                        .margin(right = if (breakpoint > Breakpoint.SM) 40.px else 0.px,
                            bottom = if (breakpoint > Breakpoint.MD) 0.px else 40.px)
                    .visibility(
                        setVisibility(
                            selectedPage = selectedPage,
    ...
    Row(modifier = Modifier.fillMaxWidth(),
        ...
        repeat(3){ index ->
            Box(modifier = Modifier
                ...
                .size(12.px)
                .borderRadius(50.px)
                .backgroundColor(if (selectedPage == index) Theme.Primary.rgb
